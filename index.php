...
<body>
        ...
        <div class="row">
            ...
            <div class="col-6 mt-5">
                <div class="card">
                    ...
                    <div class="card-footer text-end">
                        <button class="btn btn-primary" id="get_json_file" type="button">Get JSON File</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        var placeSelect = document.getElementById('place_name')
        ...
        citySelect.addEventListener('change', function() {
            ...
            console.log(value)
            console.log(name)
            getData(value, name, '.select_1')
        })
        $(document).on('change', '#place_name', function() {
            var value = this.value;
            var name = this.innerText;
            console.log(value)
            getData(value, name, '.select_2')
        })

        function getData(value, name, class_name) {
            $.ajax({
                url: 'get_city_db.php',
                method: 'post',
                data: {
                ...
                success: function(response) {
                    ...
                    if (response.status) {
                        ...
                        // html += '<select name="place_name" id="place_name" class="form-control"><option value="">Select Place</option>';
